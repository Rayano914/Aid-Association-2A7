...
bool Employe::ajouter()
{
    ...
    query.prepare("insert into employe (id_employe, nom, prenom, specialite, mail)" "values(:id_employe, :nom, :prenom, :specialite, :mail)");
...
{
    QSqlQuery query;
    query.prepare("update employe set id_employe=:id_employe, nom=:nom, prenom=:prenom, specialite=:specialite, mail=:mail where id_employe=:id_employe");
...
bool  Employe::telechargerPDF(){
                     ...
                     int i = 4000;
                          ...
                          painter.drawText(3200,3300,"Spécialite");
                          painter.drawText(4400,3300,"Mail");
                          painter.drawText(5400,3300,"ID opération");
